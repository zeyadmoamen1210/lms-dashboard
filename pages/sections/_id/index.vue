      ...
      <section v-if="addClassPopOver" class="mt-3 mb-3 add-update-section">
        ...
        <el-form :model="addSection" ref="addSection" class="for-add-or-update pt-0" style="margin-top: 5px">
          <div class="row">
            ...
            <div class="col-md-2" v-if="!this.filterSystem">
              <div>
                <el-form-item
                  prop="system"
                  :rules="[
                ...
                >
                  ...
                  >
                    <el-option
                      ...
                      :key="sys.id"
                      :label="$i18n.locale == 'ar' ? sys.nameAr : sys.nameEn"
                      :value="sys.id"
                    >
                    </el-option>
                  </el-select>
...
export default {
  ...
  watch: {
    filterSystem(val) {
      this.selectedClass = this.selectedLevel = "";
      if(val == ''){
        this.allClasses = this.allLevels = [];
  ...
  methods: {
    ...
    createNewSection() {
      ...
      this.$axios
        .post(
          `/classes/${this.selectedClass ? this.selectedClass : this.$route.params.id}/systems/${this.filterSystem ? this.filterSystem : this.addSection.system}/sections`,
          this.addSection
        )
        .then((res) => {
          this.addClassPopOver = !this.addClassPopOver;
    ...
    getClassSections() {
      ...
      this.$axios
        .get(
          ...
          }/sections${this.filterSystem > 0 ? "?system=" + this.filterSystem : ""}`
        )
        .then((res) => {
